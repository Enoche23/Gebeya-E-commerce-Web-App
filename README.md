...
Gebeya is a secure, full-stack, multi-role e-commerce application built with native PHP and MySQL. It features a complete shopping cart system, seller inventory management, and an advanced security layer including Email-based Multi-Factor Authentication (MFA).
...
3. To enable the Multi-Factor Authentication system, you must provide real SMTP credentials (e.g., from Brevo, SendGrid, or Gmail) in the `.env` file:
   ```env
