  ...
  <div class="col-12">
    <div class="card card-pad" style="max-width:720px; margin:0 auto;">
      ...
      <div class="small" style="margin-bottom:14px;">
        Choose whether you want to register as a buyer or a seller. (Single-role accounts.)
      </div>
      ...
      <form method="post" autocomplete="off">
        ...
        <select class="input" name="account_type">
          <option value="buyer"  <?= $account_type === 'buyer' ? 'selected' : '' ?>>Buyer (shop)</option>
          <option value="seller" <?= $account_type === 'seller' ? 'selected' : '' ?>>Seller (sell)</option>
        </select>
